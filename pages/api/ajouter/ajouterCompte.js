...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try{
      db.execute('INSERT INTO `compte` (id_Compte,nomCompte,user_id,methode_id,typeCompte_id) VALUES (?,?,?,?,?)',[data.id,data.nom,data.userId,data.typeCrypte,data.typeCompte] ,(error, results) => {
